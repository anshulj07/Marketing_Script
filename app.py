...
app = Flask(__name__)
app.secret_key = 'cfeea55cd8db940a326f24830c2f6b176a9e7a1fcad3e4fdd46ca8f09d840519'

UPLOAD_FOLDER = 'uploads'
os.makedirs(UPLOAD_FOLDER, exist_ok=True)
app.config['UPLOAD_FOLDER'] = UPLOAD_FOLDER

SENDGRID_API_KEY = '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'

# Function to send emails
def send_email(to_email, to_name):
    message = Mail(
        from_email='chiragthakur8006@gmail.com',
        to_emails=to_email,
